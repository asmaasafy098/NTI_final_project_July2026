...
.L__stack_usage = 21
	mov r17,r24
	mov r16,r25
	lds r24,blinkCounter.1649
	lds r25,blinkCounter.1649+1
	adiw r24,1
	cpi r24,15
	cpc r25,__zero_reg__
	brsh .L57
	sts blinkCounter.1649+1,r25
	sts blinkCounter.1649,r24
.L58:
=======
	push r28
	push r29
...
/* epilogue start */
	...
	ret
.L57:
	sts blinkCounter.1649+1,__zero_reg__
	sts blinkCounter.1649,__zero_reg__
	ldi r24,lo8(1)
	lds r25,blinkState.1650
	cpse r25,__zero_reg__
	ldi r24,0
.L59:
	sts blinkState.1650,r24
	rjmp .L58
.L60:
	...
	.local	blinkState.1650
	.comm	blinkState.1650,1,1
	.local	blinkCounter.1649
	.comm	blinkCounter.1649,2,1
	.data
