...
#define I2C_TWSR_REG       (*(volatile uint8_t *)0x21)   /* TWI Status Register          */
#define I2C_TWAR_REG       (*(volatile uint8_t *)0x22)   /* TWI (own) Slave Address Reg  */
#define I2C_TWDR_REG       (*(volatile uint8_t *)0x23)   /* TWI Data Register            */
#define I2C_TWCR_REG       (*(volatile uint8_t *)0x56)   /* TWI Control Register         */
...
#define I2C_SREG_REG       (*(volatile uint8_t *)0x5F)   /* Status Register */
